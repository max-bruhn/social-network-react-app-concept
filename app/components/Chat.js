...
const Chat = () => {
  ...
  useEffect(() => {
    socket.current = io(process.env.BACKENDURL || 'https://social-network-server-api.herokuapp.com')
  ...
  const handleFieldChange = (e) => {
    ...
    // e.target.value is not available another level deep, therefore assigned to value
    setState((draft) => {

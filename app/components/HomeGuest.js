...
import { CSSTransitions, CSSTransition } from 'react-transition-group'
...
function HomeGuest() {
    ...
    switch (action.type) {
      case 'usernameImmediatley':
        ...
        if (draft.username.value && !/^([a-zA-Z0-9]+)$/.test(draft.username.value)) {
          draft.username.hasErrors = true
          draft.username.message = 'Username can only consist of letters and numbers!'
        }
        return
      ...
      case 'emailAfterDelay':
        if (!/^\S+@\S+$/.test(draft.email.value)) {
          ...
          draft.email.message = 'Your must provide a valid email address.'
        }
      ...
      case 'passwordImmediatley':
        ...
        if (draft.password.length > 128) {
          draft.password.hasErrors = true
          draft.password.message = 'Password can not exceed 128 characters!'
        }
        return
  ...
  return (
    <Page wide={true} title="Complex App">
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input
                onChange={(e) => {
                  dispatch({ type: 'usernameImmediatley', value: e.target.value })
                }}
            ...
            <div className="form-group">
              ...
              <input
                onChange={(e) => {
                  dispatch({ type: 'emailImmediatley', value: e.target.value })
                }}
                id="email-register"
                name="email"
                className="form-control"
            ...
            <div className="form-group">
              ...
              <input
                onChange={(e) => {
                  dispatch({ type: 'passwordImmediatley', value: e.target.value })
                }}
